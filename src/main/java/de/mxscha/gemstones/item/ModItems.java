...
public class ModItems {
    ...
    public static final RegistryObject<Item> TIN_AXE = ITEMS.register("tin_axe",() -> new AxeItem(ModToolTiers.TIN, 5.0F, -3.0F, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> TIN_HOE = ITEMS.register("tin_hoe", () -> new HoeItem(ModToolTiers.TIN, -3, 0.0F, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    ...
    public static final RegistryObject<Item> TIN_HELMET = ITEMS.register("tin_helmet", () -> new ArmorItem(ModArmorTiers.TIN, EquipmentSlot.HEAD, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> TIN_CHESTPLATE = ITEMS.register("tin_chestplate", () -> new ArmorItem(ModArmorTiers.TIN, EquipmentSlot.CHEST, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> TIN_LEGGINGS = ITEMS.register("tin_leggings", () -> new ArmorItem(ModArmorTiers.TIN, EquipmentSlot.LEGS, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> TIN_BOOTS = ITEMS.register("tin_boots", () -> new ArmorItem(ModArmorTiers.TIN, EquipmentSlot.FEET, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    ...
    public static final RegistryObject<Item> SAPPHIRE_HELMET = ITEMS.register("sapphire_helmet", () -> new ArmorItem(ModArmorTiers.SAPPHIRE, EquipmentSlot.HEAD, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> SAPPHIRE_CHESTPLATE = ITEMS.register("sapphire_chestplate", () -> new ArmorItem(ModArmorTiers.SAPPHIRE, EquipmentSlot.CHEST, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> SAPPHIRE_LEGGINGS = ITEMS.register("sapphire_leggings", () -> new ArmorItem(ModArmorTiers.SAPPHIRE, EquipmentSlot.LEGS, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> SAPPHIRE_BOOTS = ITEMS.register("sapphire_boots", () -> new ArmorItem(ModArmorTiers.SAPPHIRE, EquipmentSlot.FEET, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    ...
    public static final RegistryObject<Item> RUBY_HELMET = ITEMS.register("ruby_helmet", () -> new ArmorItem(ModArmorTiers.RUBY, EquipmentSlot.HEAD, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> RUBY_CHESTPLATE = ITEMS.register("ruby_chestplate", () -> new ArmorItem(ModArmorTiers.RUBY, EquipmentSlot.CHEST, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> RUBY_LEGGINGS = ITEMS.register("ruby_leggings", () -> new ArmorItem(ModArmorTiers.RUBY, EquipmentSlot.LEGS, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> RUBY_BOOTS = ITEMS.register("ruby_boots", () -> new ArmorItem(ModArmorTiers.RUBY, EquipmentSlot.FEET, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    ...
    public static final RegistryObject<Item> CITRINE_HELMET = ITEMS.register("citrine_helmet", () -> new ArmorItem(ModArmorTiers.CITRINE, EquipmentSlot.HEAD, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> CITRINE_CHESTPLATE = ITEMS.register("citrine_chestplate", () -> new ArmorItem(ModArmorTiers.CITRINE, EquipmentSlot.CHEST, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> CITRINE_LEGGINGS = ITEMS.register("citrine_leggings", () -> new ArmorItem(ModArmorTiers.CITRINE, EquipmentSlot.LEGS, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> CITRINE_BOOTS = ITEMS.register("citrine_boots", () -> new ArmorItem(ModArmorTiers.CITRINE, EquipmentSlot.FEET, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    ...
    public static final RegistryObject<Item> AMETHYST_HELMET = ITEMS.register("amethyst_helmet", () -> new ArmorItem(ModArmorTiers.AMETHYST, EquipmentSlot.HEAD, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> AMETHYST_CHESTPLATE = ITEMS.register("amethyst_chestplate", () -> new ArmorItem(ModArmorTiers.AMETHYST, EquipmentSlot.CHEST, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> AMETHYST_LEGGINGS = ITEMS.register("amethyst_leggings", () -> new ArmorItem(ModArmorTiers.AMETHYST, EquipmentSlot.LEGS, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> AMETHYST_BOOTS = ITEMS.register("amethyst_boots", () -> new ArmorItem(ModArmorTiers.AMETHYST, EquipmentSlot.FEET, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    ...
    public static final RegistryObject<Item> DIOPSIDE_HELMET = ITEMS.register("diopside_helmet", () -> new ArmorItem(ModArmorTiers.DIOPSIDE, EquipmentSlot.HEAD, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> DIOPSIDE_CHESTPLATE = ITEMS.register("diopside_chestplate", () -> new ArmorItem(ModArmorTiers.DIOPSIDE, EquipmentSlot.CHEST, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> DIOPSIDE_LEGGINGS = ITEMS.register("diopside_leggings", () -> new ArmorItem(ModArmorTiers.DIOPSIDE, EquipmentSlot.LEGS, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> DIOPSIDE_BOOTS = ITEMS.register("diopside_boots", () -> new ArmorItem(ModArmorTiers.DIOPSIDE, EquipmentSlot.FEET, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    ...
    public static final RegistryObject<Item> JADE_HELMET = ITEMS.register("jade_helmet", () -> new ArmorItem(ModArmorTiers.JADE, EquipmentSlot.HEAD, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> JADE_CHESTPLATE = ITEMS.register("jade_chestplate", () -> new ArmorItem(ModArmorTiers.JADE, EquipmentSlot.CHEST, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> JADE_LEGGINGS = ITEMS.register("jade_leggings", () -> new ArmorItem(ModArmorTiers.JADE, EquipmentSlot.LEGS, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> JADE_BOOTS = ITEMS.register("jade_boots", () -> new ArmorItem(ModArmorTiers.JADE, EquipmentSlot.FEET, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    ...
    public static final RegistryObject<Item> CAERULA_HELMET = ITEMS.register("caerula_helmet", () -> new ArmorItem(ModArmorTiers.CAERULA, EquipmentSlot.HEAD, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> CAERULA_CHESTPLATE = ITEMS.register("caerula_chestplate", () -> new ArmorItem(ModArmorTiers.CAERULA, EquipmentSlot.CHEST, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> CAERULA_LEGGINGS = ITEMS.register("caerula_leggings", () -> new ArmorItem(ModArmorTiers.CAERULA, EquipmentSlot.LEGS, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> CAERULA_BOOTS = ITEMS.register("caerula_boots", () -> new ArmorItem(ModArmorTiers.CAERULA, EquipmentSlot.FEET, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    ...
    public static final RegistryObject<Item> ENDER_HELMET = ITEMS.register("ender_helmet", () -> new ArmorItem(ModArmorTiers.ENDER, EquipmentSlot.HEAD, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> ENDER_CHESTPLATE = ITEMS.register("ender_chestplate", () -> new ArmorItem(ModArmorTiers.ENDER, EquipmentSlot.CHEST, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> ENDER_LEGGINGS = ITEMS.register("ender_leggings", () -> new ArmorItem(ModArmorTiers.ENDER, EquipmentSlot.LEGS, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> ENDER_BOOTS = ITEMS.register("ender_boots", () -> new ArmorItem(ModArmorTiers.ENDER, EquipmentSlot.FEET, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    ...
    public static final RegistryObject<Item> FUSION_HELMET = ITEMS.register("fusion_helmet", () -> new ArmorItem(ModArmorTiers.FUSION, EquipmentSlot.HEAD, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> FUSION_CHESTPLATE = ITEMS.register("fusion_chestplate", () -> new ArmorItem(ModArmorTiers.FUSION, EquipmentSlot.CHEST, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> FUSION_LEGGINGS = ITEMS.register("fusion_leggings", () -> new ArmorItem(ModArmorTiers.FUSION, EquipmentSlot.LEGS, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> FUSION_BOOTS = ITEMS.register("fusion_boots", () -> new ArmorItem(ModArmorTiers.FUSION, EquipmentSlot.FEET, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    ...
    public static final RegistryObject<Item> FUSION_NETHERITE_HELMET = ITEMS.register("fusion_netherite_helmet", () -> new ArmorItem(ModArmorTiers.FUSION_NETHERITE, EquipmentSlot.HEAD, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> FUSION_NETHERITE_CHESTPLATE = ITEMS.register("fusion_netherite_chestplate", () -> new ArmorItem(ModArmorTiers.FUSION_NETHERITE, EquipmentSlot.CHEST, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> FUSION_NETHERITE_LEGGINGS = ITEMS.register("fusion_netherite_leggings", () -> new ArmorItem(ModArmorTiers.FUSION_NETHERITE, EquipmentSlot.LEGS, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
    public static final RegistryObject<Item> FUSION_NETHERITE_BOOTS = ITEMS.register("fusion_netherite_boots", () -> new ArmorItem(ModArmorTiers.FUSION_NETHERITE, EquipmentSlot.FEET, new Item.Properties().tab(ModItemCreativeTab.ARMORY_GEMSTONES)));
