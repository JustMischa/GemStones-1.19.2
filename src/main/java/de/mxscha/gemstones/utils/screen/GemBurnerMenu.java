...
public class GemBurnerMenu extends AbstractContainerMenu {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, entity.getBlockPos()), player, ModBlocks.GEM_BURNER.get());
    }
