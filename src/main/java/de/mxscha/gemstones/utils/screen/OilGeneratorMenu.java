...
import de.mxscha.gemstones.block.custom.entity.OilGeneratorBlockEntity;
import de.mxscha.gemstones.utils.screen.slot.ModResultSlot;
...
public class OilGeneratorMenu extends AbstractContainerMenu {

    public final OilGeneratorBlockEntity entity;
    private final Level level;
    private final ContainerData data;

    public OilGeneratorMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, entity.getBlockPos()), player, ModBlocks.OIL_GENERATOR.get());
    }
